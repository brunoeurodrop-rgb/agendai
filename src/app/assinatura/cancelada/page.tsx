  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-red-50/20 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-10 max-w-md w-full text-center">
        ...
        <p className="text-gray-500 text-sm mb-6">Nenhuma cobrança foi realizada. Você pode assinar quando quiser.</p>
        <Link href="/planos" className="btn-primary inline-block px-8 py-3">Ver planos</Link>
      </div>
    </div>
  )
}
